<template>
  <Listbox v-model="selectedTasks" as="div" class="flex gap-x-3 items-center">
    ...
    <div class="relative" style="width: 250px">
      ...
      <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100" leave-to-class="opacity-0">
        <ListboxOptions class="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
          <ListboxOption v-for="taskSelector in tasksSelector" :key="taskSelector.id" v-slot="{ active, selected }" as="template" :value="taskSelector">
...
const tasksSelector = [
  { id: 1, name: 'in progress', icon: '../../assets/icons/unselected-checkbox.svg' },
  { id: 2, name: 'done', icon: '../../assets/icons/selected-checkbox.svg' },
  { id: 3, name: 'all', icon: '../../assets/icons/all.svg' },
];
